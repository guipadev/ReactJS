  ...
  render() {
    ...
    return (
      <>
        ...
        <p>Son métodos que se ejecutan automáticamente en un Componente de Clase, ocurren en 3 fases:</p>
        <ul>
          <li>Montaje</li>
          <li>Actualización</li>
          <li>Desmontaje</li>
        </ul>
        <a href="https://jonmircha.com/react#comunicaci%C3%B3n-entre-componentes" Target="_blanck">Aquí más información</a>
        <br/>
        <br/>
